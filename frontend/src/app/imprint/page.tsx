...
export default function Authorized() {
  return (
    <Container fluid="sm" className="pt-5 container-max-width min-height">
      <h2 className="pb-3">Legal information</h2>
      <p>chargebot.io is provided to you by:</p>
      <p>
        Heinrich Beck<br />
